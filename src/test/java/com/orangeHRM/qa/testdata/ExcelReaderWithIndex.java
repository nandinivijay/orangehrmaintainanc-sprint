...
public class ExcelReaderWithIndex {//modified
	
	
	public ExcelReaderWithIndex() {
		
	}
	
	@DataProvider(name="paramName")
	public Object[][] getData(ITestContext context) throws Throwable{
		int i=(int) context.getAttribute("index");
		System.out.println("sheetnumber is : "+i);
		return readdata(i);
	}

	public String[][] readdata(  int sheetnum  ) throws IOException
	{
